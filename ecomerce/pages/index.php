...
?>
  <div class="page-header header-filter" data-parallax="true" style="background-image: url('https://cdn.pixabay.com/photo/2016/07/05/16/53/leaf-1498985_960_720.jpg')">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
      ...
      <div class="section text-center">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            <h5 class="description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores molestiae voluptas, vero voluptate, ipsum voluptatem eaque aspernatur velit nisi dolore laboriosam non soluta alias labore reprehenderit magni laudantium, architecto necessitatibus!</h5>
          </div>
        </div>
        <div class="features">
          <div class="row">
